#!/usr/bin/python3
'''Contains the API's view for places_reviews.'''
...
def get_reviews(place_id=None, review_id=None):
    '''Retrieves the review matching the given ID or
    all reviews within the place corresponding to the provided ID.
    '''
    if place_id:
...
def update_review(place_id=None, review_id=None):
    '''Updates the review identified by the provided ID.
    '''
